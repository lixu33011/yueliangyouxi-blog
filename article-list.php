...
// 获取选中的样式文件
$listTemplate = getSelectedAsset('article_list_template');
$listBackground = getSelectedAsset('article_list_background');
$bgMusic = $config['bg_music']['article_list_url'];
$bgVolume = $config['bg_music']['article_list_volume'];
...
<div class="date-float-container">
    ...
    <div class="article-list-container">
        <h2 class="article-list-title">月亮有喜的博客</h2>
        <?php if (empty($articles)): ?>
        <div style="text-align:center; color:#fff; font-size:18px; padding: 50px; background: rgba(0,0,0,0.5); border-radius: 10px;">暂无文章</div>
        <?php else: ?>
